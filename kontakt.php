    ...
    <script>
        function validateForm() {
            ...
            if (name.length < 3) {
                ...
                errorOutput.innerText = "Der Name muss mindestens 3 Zeichen lang sein.";
            ...
            if (!emailPattern.test(email)) {
                ...
                errorOutput.innerText = "Bitte eine gültige E-Mail-Adresse eingeben.";
                return false; // Formular nicht absenden
            }
            ...
            if (message.length < 10) {
                ...
                errorOutput.innerText = "Die Nachricht muss mindestens 10 Zeichen lang sein.";
                return false; // Formular nicht absenden
            }
        ...
        <nav>
            <ul role="homebutton" class="cs-nav-links">
                <li role="presentation">
                    <a role="menuitem" href="index.html">Eva Günzler</a>
                </li>
            </ul>
            <ul role="menubar" class="cs-nav-links">
                <li role="presentation"><a role="menuitem" href="index.html">Zurück</a></li>
            </ul>
        </nav>
    </header>
    <section id="contact-me">
        <div class="content-container">
            ...
            <?php
                ...
                if ($_GET['success'] == '1') {
                     echo '<p style="color: green;">Die Nachricht wurde erfolgreich gesendet.</p>';
                 } else {
            ...
            <div class="flex-container">
                <div class="form-intro-text">
                    <p>Nehmen Sie Kontakt mit mir auf!<br>Ich freue mich auf Ihre Nachricht.</p>
                </div>
                <div class="contact-form">
                    ...
                    <form action="https://www.guenzler.net/send_email.php" method="POST"
                        ...
                        <ul>
                            ...
                            <li role="presentation">
                                <label class="standard-label" for="message">Nachricht*:</label>
